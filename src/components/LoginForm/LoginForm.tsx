    ...
    <div className="form_layout">
      <div className="container">
        <div className="form_main">
          ...
          <button className="form_toggle" onClick={() => setReg(!reg)}>
  ...
  return (
    ...
    >
      <Form className="form_formik form_formik_reg " action="">
        ...
        <button className={loading ? "disabled" : ""}>Регистрация</button>
        {statusCode === 200 ? (
          <div className="form_status">Вы успешно зарегестрировались</div>
          
        ) : statusCode === 400 ? (
          <div className="form_status">Произошла ошибка, попробуйте снова</div>
        ) : (
          ""
        )}
      </Form>
